...
export default defineConfig({
  ...
  description: "The missing dependency updater for Gradle. Fast, precise, and security-focused CLI.",
  
  head: [
    ['link', { rel: 'icon', href: '/gradle-check-updates/favicon.ico' }],
    ['meta', { property: 'og:type', content: 'website' }],
    ['meta', { property: 'og:title', content: 'gradle-check-updates' }],
    ['meta', { property: 'og:description', content: 'The missing dependency updater for Gradle. Fast, precise, and security-focused.' }],
    ...
    ['script', { type: 'application/ld+json' }, JSON.stringify({
      ...
      "description": "Fast, precise dependency updater for Gradle projects.",
